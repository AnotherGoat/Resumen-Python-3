...
Esta ruta puede ser \link{https://www.discoduroderoer.es/rutas-relativas-y-absolutas/}{relativa} (desde el directorio de trabajo) o \link{https://www.discoduroderoer.es/rutas-relativas-y-absolutas/}{absoluta}.\medskip
...
Se puede añadir el signo \ttt{\qq + \qq} a cualquiera de los modos de arriba para darles acceso adicional a archivos.\medskip
...
El ejemplo de arriba primero mostrará los bytes del \ttt{1} al \ttt{16}, después del \ttt{17} al \ttt{24}, del \ttt{25} al \ttt{28}, y del \ttt{29} al último byte.\medskip
...
Sin embargo, existe una forma más cómoda de hacer esto usando declaraciones \ttt{with}.\medskip
...
El archivo se cierra automáticamente al final de la declaración \ttt{with}, incluso si ocurren excepciones dentro de ella.\medskip
...
Comparado con la forma tradicional de trabajar con archivos (usar \ttt{open()} y después \ttt{close()}), usar \ttt{with} tiene el inconveniente de que los archivos tienen que volverse a abrir cada vez que se quiera trabajar con ellos.\medskip
