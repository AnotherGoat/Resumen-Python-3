...
Los nombres de variables que se componen de más de una palabra pueden ser difíciles de leer. Existen muchas técnicas para escribirlos de forma más legible.
...
También se pueden usar estos métodos para forzar variables a ser de un tipo específico al momento de asignarlas, en vez de dejar que Python infiera su tipo. Esto se conoce como \doble{casting}.
