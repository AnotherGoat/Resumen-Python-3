...
Como los argumentos de \ttt{range()}, el primer índice provisto en un corte es incluido en el resultado, pero el segundo no.\smallskip
...
En Python pueden usarse cortes para obtener trozos de una cadena. Esto es lo que en otros lenguajes de programación se realiza usando el método \ttt{substring()}. Funciona de la misma forma que con listas y tuplas.
...
Las listas por compresión son inspiradas por la notación de \link{https://edu.gcfglobal.org/es/los-conjuntos/notacion-de-conjuntos/1/}{constructores de conjuntos} en las matemáticas.\smallskip
...
\begin{itemize}
  ...
  \item A diferencia de otros lenguajes de programación, Python no tiene el método \ttt{contains()}, para ver si una subcadena pertenece a un string.\smallskip
...
Al método \ttt{split()} visto anteriormente también se le puede entregar un string separador. La lista será formada con los elementos entre cada aparición de ese string.
...
Las funciones \ttt{all()} y \ttt{any()} son utilizados con frecuencia como sentencias condicionales. Estos toman una lista como un argumento y devuelven \ttt{True} si todos o algunos (respectivamente) de sus argumentos son evaluados como \ttt{True} (o, de lo contrario, devuelve \ttt{False}).
