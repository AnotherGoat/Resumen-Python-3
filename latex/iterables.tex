...
\pythonfile{codigo/iterables/cortes_1.py}
\out{codigo/iterables/cortes_1.out}
...
\pythonfile{codigo/iterables/cortes_2.py}
\out{codigo/iterables/cortes_2.out}
...
\pythonfile{codigo/iterables/cortes_3.py}
\out{codigo/iterables/cortes_3.out}
...
\pythonfile{codigo/iterables/cortes_4.py}
\out{codigo/iterables/cortes_4.out}

El tamaño de paso también puede ser negativo, lo que permite usarlos para invertir listas sin usar el método \ttt{reverse()}.

\pythonfile{codigo/iterables/cortes_reverse.py}
\out{codigo/iterables/cortes_reverse.out}
...
\pythonfile{codigo/iterables/copy_cortes.py}
\out{codigo/iterables/copy_cortes.out}
...
\pythonfile{codigo/iterables/cortes_en_tuplas.py}
\out{codigo/iterables/cortes_en_tuplas.out}
...
\pythonfile{codigo/iterables/compresion_1.py}
\out{codigo/iterables/compresion_1.out}
...
\pythonfile{codigo/iterables/compresion_2.py}
\out{codigo/iterables/compresion_2.out}
...
\pythonfile{codigo/iterables/compresion_3.py}
...
\pythonfile{codigo/iterables/formateo_1.py}
\out{codigo/iterables/formateo_1.out}
...
\pythonfile{codigo/iterables/formateo_2.py}
\out{codigo/iterables/formateo_2.out}

Si se omite un índice, habrá algún argumento de \ttt{format()} que no se usará.

\pythonfile{codigo/iterables/formateo_3.py}
\out{codigo/iterables/formateo_3.out}
...
\pythonfile{codigo/iterables/formateo_4.py}
\out{codigo/iterables/formateo_4.out}

El formateo de cadenas también puede hacerse con argumentos con nombre.

\pythonfile{codigo/iterables/formateo_5.py}
\out{codigo/iterables/formateo_5.out}
...
\begin{itemize}
  ...
  \pythonfile{codigo/iterables/join.py}
  \out{codigo/iterables/join.out}

  \item \ttt{replace()}: Reemplaza una subcadena de una cadena por otra cadena.

  \pythonfile{codigo/iterables/replace.py}
  \out{codigo/iterables/replace.out}

  %TODO: separar esta sección

  \item \ttt{startswith()}: Determina si hay una subcadena al principio de una cadena.

  \pythonfile{codigo/iterables/startswith.py}
  \out{codigo/iterables/startswith.out}

  \item \ttt{endswith()}: Determina si hay una subcadena al final de una cadena.
  
  \pythonfile{codigo/iterables/endswith.py}
  \out{codigo/iterables/endswith.out}
  ...
  \pythonfile{codigo/iterables/contains.py}
  \out{codigo/iterables/contains.out}

  %TODO: separar esta sección

  \item \ttt{upper()}: Cambia una cadena a mayúsculas.
  
  \pythonfile{codigo/iterables/upper.py}
  \out{codigo/iterables/upper.out}

  \item \ttt{lower()}: Cambia una cadena a minúsculas.
  
  \pythonfile{codigo/iterables/lower.py}
  \out{codigo/iterables/lower.out}

  \item \ttt{capitalize()}: Cambia una cadena para que la primera letra sea mayúscula y el resto minúsculas.

  \pythonfile{codigo/iterables/capitalize.py}
  \out{codigo/iterables/capitalize.out}
  
  \item \ttt{title()}: Cambia una cadena para que todas las palabras empiecen con mayúscula.
  
  \pythonfile{codigo/iterables/title.py}
  \out{codigo/iterables/title.out}
...
\pythonfile{codigo/iterables/all.py}
\out{codigo/iterables/all.out}
\pythonfile{codigo/iterables/any.py}
\out{codigo/iterables/any.out}
...
\pythonfile{codigo/iterables/enumerate_1.py}
\out{codigo/iterables/enumerate_1.out}

También se puede especificar el índice desde el que comienza.

\pythonfile{codigo/iterables/enumerate_2.py}
\out{codigo/iterables/enumerate_2.out}
