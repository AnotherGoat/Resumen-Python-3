...
\pythonfile{codigo/strings/cadena.py}
...
\pythonfile{codigo/strings/cadena_vacia.py}
...
\pythonfile{codigo/strings/caracteres_especiales.py}
\out{codigo/strings/caracteres_especiales.out}
...
\pythonfile{codigo/strings/comillas.py}
\out{codigo/strings/comillas.out}
...
\begin{itemize}
  ...
  \pythonfile{codigo/strings/newline.py}
  \out{codigo/strings/newline.out}
  ...
  \pythonfile{codigo/strings/tab.py}
  \out{codigo/strings/tab.out}
...
\begin{itemize}
  ...
  \pythonfile{codigo/strings/carriage_return.py}
  \out{codigo/strings/carriage_return.out}
  ...
  \pythonfile{codigo/strings/form_feed.py}
...
\pythonfile{codigo/strings/unicode.py}
\out{codigo/strings/unicode.out}
...
\pythonfile{codigo/strings/raw_string.py}
\out{codigo/strings/raw_string.out}
...
\pythonfile{codigo/strings/string_multilinea.py}
\out{codigo/strings/string_multilinea.out}
...
\pythonfile{codigo/strings/concatenacion.py}
\out{codigo/strings/concatenacion.out}

La concatenación sólo se puede realizar entre strings, no entre cadenas y números.

\pythonfile{codigo/strings/error_concatenacion.py}
\out{codigo/strings/error_concatenacion.out}
...
\pythonfile{codigo/strings/multiplicar_cadenas_1.py}
\out{codigo/strings/multiplicar_cadenas_1.out}

También se pueden combinar operaciones de multiplicación y concatenación.

\pythonfile{codigo/strings/concatenacion_y_multiplicacion.py}

Multiplicar por \ttt{0} genera un string vacío.

\pythonfile{codigo/strings/multiplicar_cadenas_2.py}
\out{codigo/strings/multiplicar_cadenas_2.out}
...
\pythonfile{codigo/strings/cadena_x_cadena.py}
\out{codigo/strings/cadena_x_cadena.out}
\pythonfile{codigo/strings/cadena_x_float.py}
\out{codigo/strings/cadena_x_float.out}
...
\pythonfile{codigo/strings/substring_1.py}
\out{codigo/strings/substring_1.out}
...
\pythonfile{codigo/strings/print_avanzado_1.py}
\out{codigo/strings/print_avanzado_1.out}
...
\pythonfile{codigo/strings/print_avanzado_2.py}
\out{codigo/strings/print_avanzado_2.out}
...
\pythonfile{codigo/strings/print_avanzado_3.py}
\out{codigo/strings/print_avanzado_3.out}
\pythonfile{codigo/strings/print_avanzado_4.py}
\out{codigo/strings/print_avanzado_4.out}

Ambos argumentos se pueden combinar.

\pythonfile{codigo/strings/print_avanzado_5.py}
\out{codigo/strings/print_avanzado_5.out}
...
\pythonfile{codigo/strings/lorem_ipsum.py}
\out{codigo/strings/lorem_ipsum.out}
