...
\pythonfile{codigo/excepciones/excepcion.py}
\out{codigo/excepciones/excepcion.out}
...
\pythonfile{codigo/excepciones/try_except_1.py}
\inp{codigo/excepciones/try_except_1.inp_1}
\out{codigo/excepciones/try_except_1.out_1}
\inp{codigo/excepciones/try_except_1.inp_2}
\out{codigo/excepciones/try_except_1.out_2}
...
\pythonfile{codigo/excepciones/try_except_2.py}
\inp{codigo/excepciones/try_except_2.inp}
\out{codigo/excepciones/try_except_2.out}
...
\pythonfile{codigo/excepciones/except.py}
\out{codigo/excepciones/except.out}
...
\pythonfile{codigo/excepciones/try_except_3.py}
...
\pythonfile{codigo/excepciones/finally_1.py}
\out{codigo/excepciones/finally_1.out}
...
\pythonfile{codigo/excepciones/finally_2.py}
\out{codigo/excepciones/finally_2.out}
...
\pythonfile{codigo/excepciones/raise_1.py}
\out{codigo/excepciones/raise_1.out}

Las excepciones pueden ser levantadas con argumentos que den detalles sobre ellas.

\pythonfile{codigo/excepciones/raise_2.py}
\out{codigo/excepciones/raise_2.out}
\pythonfile{codigo/excepciones/raise_3.py}
\inp{codigo/excepciones/raise_3.inp}
\out{codigo/excepciones/raise_3.out}
...
\pythonfile{codigo/excepciones/raise_4.py}
\out{codigo/excepciones/raise_4.out}

Usar \ttt{raise} fuera de los contextos mencionados anteriormente levantará un \ttt{RuntimeError}.

\pythonfile{codigo/excepciones/error_raise.py}
\out{codigo/excepciones/error_raise.out}
...
\pythonfile{codigo/excepciones/assert_1.py}
\out{codigo/excepciones/assert_1.out}
...
\pythonfile{codigo/excepciones/assert_2.py}
\out{codigo/excepciones/assert_2.out}
...
\pythonfile{codigo/excepciones/error_assert.py}
\out{codigo/excepciones/error_assert.out}
...
\pythonfile{codigo/excepciones/validacion_1.py}
\inp{codigo/excepciones/validacion_1.inp_1}
\out{codigo/excepciones/validacion_1.out_1}
\inp{codigo/excepciones/validacion_1.inp_2}
\out{codigo/excepciones/validacion_1.out_2}

Para manejar este error, se debería usar un \ttt{try-except} para atrapar la excepción \ttt{ValueError}.

\pythonfile{codigo/excepciones/validacion_2.py}
\inp{codigo/excepciones/validacion_2.inp}
\out{codigo/excepciones/validacion_2.out}
...
\pythonfile{codigo/excepciones/validacion_3.py}
\inp{codigo/excepciones/validacion_3.inp}
\out{codigo/excepciones/validacion_3.out}
...
\pythonfile{codigo/excepciones/validacion_4.py}
\inp{codigo/excepciones/validacion_4.inp}
\out{codigo/excepciones/validacion_4.out}
