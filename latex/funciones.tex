...
Los argumentos de funciones pueden ser utilizados como variables dentro de la definición de la función. Sin embargo, no pueden ser referenciados fuera de dicha definición. Esto también se aplica a las demás variables creadas dentro de una función.
...
Los parámetros de una función también son variables locales.\smallskip

Existe una excepción a esta regla, la cual permite declarar variables globales dentro del cuerpo de una función. Para hacer esto, se debe usar la palabra clave \ttt{global}.

\pythonfile{codigo/8-funciones/global.py}
\out{codigo/8-funciones/global.out}

Es importante darse cuenta de que la función \ttt{funcion()} debe ser llamada para inicializar la variable global \ttt{z} y que al usar la palabra clave \ttt{global} se debe separar la declaración de la asignación.\smallskip
