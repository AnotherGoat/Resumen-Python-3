...
PEP proviene del inglés Python Enhancement Proposals, que significa Propuestas de Mejoras de Python. Son sugerencias para mejoras al lenguaje, hechas por desarrolladores experimentados de Python. El Zen de Python visto en el primer capítulo es el \link{https://www.python.org/dev/peps/pep-0020/}{PEP 20}.\smallskip

En este capítulo se verán algunos de los PEP más importantes, y un resumen sobre sus contenidos. La lista completa de PEPs puede encontrarse su \link{https://www.python.org/dev/peps/}{índice}, donde se puede leer el contenido completo de cada uno.

\section{PEP 8}

El \link{https://www.python.org/dev/peps/pep-0008/}{PEP 8} es una guía de estilo sobre el tema de escritura de código legible. Contiene una serie de directrices en referencia a los nombres de variables, que pueden resumirse de esta forma.
