...
Los números generados son pseudoaleatorios porque la aleatoriedad \doble{natural} no existe en los computadores. Todas las funciones que generan elementos al azar en realidad emplean algoritmos impredecibles.\smallskip
...
La función \ttt{choices()} permite seleccionar elementos de una lista al azar \ttt{k} veces (similar a decir \doble{con reposición}). Este número puede ser mayor al número de elementos de la lista.
