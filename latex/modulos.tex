...
\pythonfile{codigo/modulos/ejemplo_modulos.py}
...
\pythonfile{codigo/modulos/import_1.py}
\out{codigo/modulos/import_1.out}

Para importar más de un elemento, se debe hacer una lista separada por comas.

\pythonfile{codigo/modulos/import_2.py}
...
\pythonfile{codigo/modulos/import_todo.py}
\out{codigo/modulos/import_todo.out}
...
\pythonfile{codigo/modulos/import_3.py}
\out{codigo/modulos/import_3.out}

Para ver una lista de módulos disponibles, se puede usar la función \ttt{help()} de la siguiente forma:

\pythonfile{codigo/modulos/lista_modulos.py}
...
\pythonfile{codigo/modulos/error_import.py}
\out{codigo/modulos/error_import.out}
...
\pythonfile{codigo/modulos/alias_1.py}
\out{codigo/modulos/alias_1.out}

También se puede usar un alias con más de un objeto.

\pythonfile{codigo/modulos/alias_2.py}
\out{codigo/modulos/alias_2.out}

Después de darle un alias a un objeto, su nombre original no funcionará.

\pythonfile{codigo/modulos/error_alias.py}
\out{codigo/modulos/error_alias.out}

La notación mixta, importando algunos objetos con alias y otros sin alias, está permitida.

\pythonfile{codigo/modulos/alias_3.py}
\out{codigo/modulos/alias_3.out}

Otra opción posible es importar un módulo con un nombre distinto.

\pythonfile{codigo/modulos/alias_4.py}
\out{codigo/modulos/alias_4.out}
...
\textfile{codigo/modulos/biblioteca_estandar.txt}
...
\textfile{codigo/modulos/pip_1.txt}
...
\textfile{codigo/modulos/pip_2.txt}
...
\pythonfile{codigo/modulos/ayuda_1.py}
\out{codigo/modulos/ayuda_1.out}

Esto permite saber con facilidad qué métodos se pueden usar con la variable que se está usando.

\pythonfile{codigo/modulos/ayuda_2.py}
\out{codigo/modulos/ayuda_2.out}
...
\pythonfile{codigo/modulos/ayuda_3.py}
\out{codigo/modulos/ayuda_3.out}

El método \ttt{help()} también se puede usar para obtener ayuda detallada sobre módulos importados.

\pythonfile{codigo/modulos/ayuda_4.py}
\out{codigo/modulos/ayuda_4.out}
...
\pythonfile{codigo/modulos/ayuda_5.py}
\out{codigo/modulos/ayuda_5.out}
