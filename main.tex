...
\chapterfont{\color{DarkOliveGreen}}
\sectionfont{\color{RoyalBlue}}

% también en la tabla de contenidos
\renewcommand{\cftchapfont}{\bfseries\color{DarkOliveGreen}}
...
\pythonfile{codigo/8-funciones/funciones_como_objeto_1.py}

Las funciones también pueden ser usadas como argumentos de otras funciones.

\pythonfile{codigo/8-funciones/funciones_como_objeto_2.py}
