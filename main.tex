...
\usepackage[colorlinks=true, linkcolor=., urlcolor=DarkGreen]{hyperref}
...
\newmintedfile{python}{bgcolor=LightGray, frame=single, linenos, numbersep=6pt, breaklines}
...
\outfile{codigo/1-intro/hola_mundo_1.out}
