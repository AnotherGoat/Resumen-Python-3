...
Se aplican ciertas restricciones con respecto a los caracteres que se pueden usar en los nombres de variables. Los únicos caracteres permitidos son letras, números y guiones bajos. Además, no se puede comenzar con números o incluir espacios.\smallskip
...
Si se asigna el valor numérico o alfanumérico (cadena de texto) de una variable a otra, los cambios hechos a ambas variables son independientes.
...
Una lista más detallada de excepciones se puede encontrar en la \href{https://docs.python.org/3/library/exceptions.html}{documentación oficial}.
...
Todos los constructores de una clase deben tener \ttt{self} como su primer parámetro. No se necesita entregar al momento de instanciar.\smallskip
...
En el constructor \ttt{\_\_init\_\_()}, se le dan los parámetros self, nombre y edad. El parámetro self se refiere a la instancia, nombre se refiere al nombre que se le quiere dar a la persona y edad se refiere a la edad de la persona.\smallskip
...
\out{codigo/20-objetos/herencia_1.py}
